...
module.exports = {
  input: {
    path: "./arches_advanced_search/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_advanced_search/locale", // output path of all created files
