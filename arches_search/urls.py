...
from arches_search.views.api.resource_names_for_payload import (
...
urlpatterns = [
    ...
    path(
        "api/advanced-search/resource-names-for-payload",
        ResourceNamesForPayloadAPI.as_view(),
        name="resource_names_for_payload",
    ),
    path(
    ...
    path(
        "api/saved-searches",
        SavedSearchAPI.as_view(),
        name="saved_searches",
    ),
    path(
        "api/saved-searches/<uuid:savedsearchid>",
        SavedSearchAPI.as_view(),
        name="saved_search",
    ),
    path(
    ...
    path(
        "api/arches-search/mvt/empty/<int:zoom>/<int:x>/<int:y>.pbf",
        EmptySearchTileAPI.as_view(),
        name="search_mvt_empty",
    ),
    path(
