...
class ResourceInstanceListAdvancedSearchFacetIntegrationTestCase(TestCase):
    def setUp(self):
        ...
        self.any_resource_instance_list_node = Node.objects.create(
            nodeid=uuid.uuid4(),
        ...
        self.any_match_tile = TileModel(
            ...
            data={str(self.any_resource_instance_list_node.nodeid): [self.link_to_a]},
        ...
        self.any_other_tile = TileModel(
            ...
            data={str(self.any_resource_instance_list_node.nodeid): [self.link_to_c]},
            provisionaledits=None,
        )
        ...
        self.all_resource_instance_list_node = Node.objects.create(
            nodeid=uuid.uuid4(),
        ...
        self.all_match_tile = TileModel(
            ...
            data={
                str(self.all_resource_instance_list_node.nodeid): [
                    self.link_to_a,
                    self.link_to_b,
                ]
            },
        ...
        self.all_other_tile = TileModel(
            ...
            data={str(self.all_resource_instance_list_node.nodeid): [self.link_to_a]},
            provisionaledits=None,
        )
        ...
        self.only_resource_instance_list_node = Node.objects.create(
            nodeid=uuid.uuid4(),
        ...
        self.only_match_tile = TileModel(
            ...
            data={
                str(self.only_resource_instance_list_node.nodeid): [
                    self.link_to_a,
                    self.link_to_b,
                ]
            },
        ...
        self.none_resource_instance_list_node = Node.objects.create(
            nodeid=uuid.uuid4(),
        ...
        self.none_match_tile = TileModel(
            ...
            data={str(self.none_resource_instance_list_node.nodeid): [self.link_to_c]},
            provisionaledits=None,
        )
        ...
        self.none_other_tile = TileModel(
            ...
            data={str(self.none_resource_instance_list_node.nodeid): [self.link_to_a]},
            provisionaledits=None,
        )
        ...
        self.count_resource_instance_list_node = Node.objects.create(
            nodeid=uuid.uuid4(),
        ...
        self.count_more_resource = ResourceInstance(
            resourceinstanceid=uuid.uuid4(),
            graph=self.count_graph,
        )
        self.count_more_resource.save()
        self.count_fewer_resource = ResourceInstance(
            resourceinstanceid=uuid.uuid4(),
            graph=self.count_graph,
        )
        self.count_fewer_resource.save()

        self.count_more_tile = TileModel(
            tileid=uuid.uuid4(),
            nodegroup=self.count_nodegroup,
            resourceinstance=self.count_more_resource,
            data={
                str(self.count_resource_instance_list_node.nodeid): [
                    self.link_to_a,
                    self.link_to_b,
                ]
            },
        ...
        self.count_more_tile.save()
        self.count_fewer_tile = TileModel(
            tileid=uuid.uuid4(),
            nodegroup=self.count_nodegroup,
            resourceinstance=self.count_fewer_resource,
            data={str(self.count_resource_instance_list_node.nodeid): [self.link_to_a]},
            provisionaledits=None,
        )
        self.count_fewer_tile.save()
        ...
        self.presence_resource_instance_list_node = Node.objects.create(
            nodeid=uuid.uuid4(),
        ...
        self.tile_with_value = TileModel(
            ...
            data={
                str(self.presence_resource_instance_list_node.nodeid): [self.link_to_a]
            },
            provisionaledits=None,
        )
